...
--
-- Deliberately placed OUTSIDE supabase/migrations/ so a routine
-- `supabase db push` cannot pick this up by accident. Naming follows this
-- project's own existing convention for held-for-review SQL (see the
-- several "_NOT_APPLIED.sql" files already in
-- docs/metro-launch-audit/munich/).
--
