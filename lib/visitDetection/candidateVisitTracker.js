...
// Product requirement (2026-09-25): a real qualified detected visit lets
// the user check off that exact experience from elsewhere for SEVEN DAYS
// after the visit — this is the window candidate_visits.expires_at encodes,
// and what the server-side confirm authorization
// (supabase/migrations/20260924_visit_detection_duplicate_guard.sql's
// v_cv_expires_at check) actually enforces. Was 24h during the Phase 1
// pilot; widened to match this requirement.
...
// Marks candidate visits past their 7-day grace period (GRACE_PERIOD_MS)
