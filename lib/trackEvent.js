...
// Lists Landing Redesign (2026-09-19) — 'lists_tab_view' fires once per
// Lists tab focus, same reasoning as 'nearby_view'/'saved_collection_view'
// (no natural itemId/listId subject).
const DEBOUNCED_TYPES = new Set(['list_view', 'item_view', 'saved_collection_view', 'nearby_view', 'lists_tab_view'])
